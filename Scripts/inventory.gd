...
var PICKUP_ITEM_SCENES = {
	"Sword": preload("res://Scenes/sword_pick_up.tscn"),
	"Hammer": preload("res://Scenes/hammer_pick_up.tscn"),
	"Magic Blue": preload("res://Scenes/magic_wand_blue_pick_up.tscn"),
	"Boots" : preload("res://Scenes/boots_pickup.tscn"),
	"Armor": preload("res://Scenes/armor_pick_up.tscn"),
	"Health Potion": preload("res://Scenes/health_potion.tscn"),
	"Mana Potion": preload("res://Scenes/mana_potion.tscn")
}
